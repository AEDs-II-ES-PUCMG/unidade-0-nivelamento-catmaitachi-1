...
public class Pedido {
	...
	public int getMaxProdutos() { return MAX_PRODUTOS; }
	public ItemDePedido[] getItems() { return produtos; }
	...
	public boolean incluirProduto(Produto novo, int quantidade) {
		...
		if (quantProdutos < MAX_PRODUTOS) {
			produtos[quantProdutos++] = new ItemDePedido( novo, quantidade, novo.valorVenda() );
			return true;
		}
		return false;
	}
	...
	public double valorFinal() {
		...
		for (int i = 0; i < quantProdutos; i++) {
			valorPedido += produtos[i].calcularSubtotal();
		}
	...
	public String toString() {
		...
		stringPedido.append("\nData do pedido:" + formatoData.format(dataPedido) + "\n");
